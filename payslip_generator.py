...
GMAIL_USER = os.getenv("GMAIL_USER", "Ttytem@gmail.com")  # Replace with your Gmail address
GMAIL_PASS = os.getenv("GMAIL_PASS", "jqxhjgzrbxhuzrwv")    # Replace with your App Password (if using 2FA)
